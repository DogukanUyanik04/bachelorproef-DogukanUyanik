...
correct aanleren van deze vaardigheid aan zorgverleners cruciaal is \autocite{Olasveengen2021}.
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1.0\textwidth]{../voorstel/graphics/planning.png}
